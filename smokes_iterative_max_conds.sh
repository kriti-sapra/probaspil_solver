...
python iterative_prob_aspal.py -f experiments/smokes.lp -mh 30 -mc 1 >> results/smokes_iterative_mc.txt

echo "Experiment 2 \n" >> results/smokes_iterative_mc.txt
echo "Experiment 2 \n"

python iterative_prob_aspal.py -f experiments/smokes.lp -mh 30 -mc 2 >> results/smokes_iterative_mc.txt

echo "Experiment 3 \n" >> results/smokes_iterative_mc.txt
echo "Experiment 3 \n"

python iterative_prob_aspal.py -f experiments/smokes.lp -mh 30 -mc 3 >> results/smokes_iterative_mc.txt

echo "Experiment 4 \n" >> results/smokes_iterative_mc.txt
echo "Experiment 4 \n"

python iterative_prob_aspal.py -f experiments/smokes.lp -mh 30 -mc 4 >> results/smokes_iterative_mc.txt
